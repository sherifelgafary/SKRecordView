...
//    UIImage *image = [UIImage imageNamed:@"rec2.png"];
...
//    [attachButton setFrame:CGRectMake(self.inputToolbar.contentView.rightBarButtonItem.frame.size.width + 10, 0, 25, height)];
    
    self.inputToolbar.contentView.rightBarButtonItemWidth = 90;
//    [self.inputToolbar.contentView.rightBarButtonContainerView addSubview:attachButton];
    self.inputToolbar.contentView.rightBarButtonItem.titleLabel.textAlignment = NSTextAlignmentLeft;
